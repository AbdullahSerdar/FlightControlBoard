...
Tests/Unity/%.o Tests/Unity/%.su Tests/Unity/%.cyclo: ../Tests/Unity/%.c Tests/Unity/subdir.mk
...
clean: clean-Tests-2f-Unity

clean-Tests-2f-Unity:
	-$(RM) ./Tests/Unity/unity.cyclo ./Tests/Unity/unity.d ./Tests/Unity/unity.o ./Tests/Unity/unity.su

.PHONY: clean-Tests-2f-Unity
